...
function FormatAttachmentInfo(data) {
    $.post(
        "https://eko-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://eko-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://eko-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://eko-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://eko-inventory/SetInventoryData",
        JSON.stringify({
        ...
        if (
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://eko-inventory/getCombineItem",
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        $('#player-crafting-rep').html(data.charitemcrafting)  
        $('#player-attachcrafting-rep').html(data.charattachcrafting) 
        $('.health').css('height',data.charhealth+'%')
        $('.shield').css('height',data.chararmor+'%')
        $('.hunger').css('height',data.charhunger+'%')
        $('.thirst').css('height',data.charthirst+'%')
        $('.stress').css('height',data.charstress+'%')
